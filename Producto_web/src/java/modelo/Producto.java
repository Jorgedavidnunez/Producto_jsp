...
public class Producto {
    ...
    public DefaultTableModel leer(){
        ...
        try{
            cn = new Conexion();
            String query = "SELECT p.idproducto as id,p.producto,m.marca,p.idmarca,p.descripcion,p.precio_costo,p.precio_venta,p.existencia FROM productos as p inner join marcas as m on p.idmarca = m.idmarca order by id;";
            cn.abrir_conexion();
